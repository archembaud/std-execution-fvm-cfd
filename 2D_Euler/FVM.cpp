...
void ComputeFluxesFromPrimitives(const int direction, std::vector<float>&p0, std::vector<float>&p1, std::vector<float>&p2, std::vector<float>&p3,
    ...
    */
    std::for_each(
        ...
        p0.begin(),
        p0.end(),
        [direction, &p0, &p1, &p2, &p3, &u0, &u1, &u2, &u3, &Fp0, &Fp1, &Fp2, &Fp3, &Fm0, &Fm1, &Fm2, &Fm3](float& elem) {
            ComputeFluxesFromP(elem, direction, p0, p1, p2, p3, u0, u1, u2, u3, Fp0, Fp1, Fp2, Fp3, Fm0, Fm1, Fm2, Fm3);
        }
    );
}
...
void ComputeConservedChangeFromFluxes(const int direction, std::vector<float>&Fp0, std::vector<float>&Fp1, std::vector<float>&Fp2, std::vector<float>&Fp3,
    ...
    */
    std::for_each(
        ...
        Fp0.begin(),
        Fp0.end(),
        [direction, &Fp0, &Fp1, &Fp2, &Fp3, &Fm0, &Fm1, &Fm2, &Fm3, &du0, &du1, &du2, &du3](float& elem) {
            ComputeDeltaUFromP(elem, direction, Fp0, Fp1, Fp2, Fp3, Fm0, Fm1, Fm2, Fm3, du0, du1, du2, du3);
        }
    );
}
...
void UpdateConservedQuantitiesFromdU(const int update_primitives,
    ...
    */
    std::for_each(
        ...
        du0.begin(),
        du0.end(),
        [update_primitives, &du0, &du1, &du2, &du3, &u0, &u1, &u2, &u3, &p0, &p1, &p2, &p3](float& elem) {
            UpdateConservedQuantities(elem, update_primitives, du0, du1, du2, du3, u0, u1, u2, u3, p0, p1, p2, p3);
        }
    );
}
...
void ComputeConservedFromPrimitives(std::vector<float>&p0, std::vector<float>&p1, std::vector<float>&p2, std::vector<float>&p3, 
    ...
    std::for_each(
        ...
        [&p0, &p1, &p2, &p3, &u0, &u1, &u2, &u3](float& elem) {
            ComputeAllUFromP(elem, p0, p1, p2, p3, u0, u1, u2, u3);
        }
    );
}
...
void UpdateConservedQuantities(float& elem, const int update_primitives, std::vector<float>& dmass, std::vector<float>& dxmom, std::vector<float>& dymom, std::vector<float>& deng,
                               std::vector<float>& mass, std::vector<float>& xmom, std::vector<float>& ymom, std::vector<float>& eng, 
...
void ComputeFluxesFromP(float& elem, const int direction, const std::vector<float>& density, const std::vector<float>& xvel, const std::vector<float>& yvel, const std::vector<float>& temp,
                        std::vector<float>& mass, std::vector<float>& xmom, std::vector<float>& ymom, std::vector<float>& eng,
