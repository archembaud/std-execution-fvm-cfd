...
void ComputeFluxesFromP(int index, int direction, const std::vector<float>& density, const std::vector<float>& xvel, const std::vector<float>& yvel, const std::vector<float>& temp,
    std::vector<float>& mass, std::vector<float>& xmom, std::vector<float>& ymom, std::vector<float>& eng,
...
void UpdateConservedQuantities(int index, const int update_primitives,
    std::vector<float>& dmass, std::vector<float>& dxmom, std::vector<float>& dymom, std::vector<float>& deng,
    std::vector<float>& mass, std::vector<float>& xmom, std::vector<float>& ymom, std::vector<float>& eng, 
